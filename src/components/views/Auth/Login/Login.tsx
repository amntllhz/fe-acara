                    ...
                    <Card className="p-6 rounded-xl shadow-none ring-1 ring-gray-200/75">
                        <div className="flex flex-col gap-4">
                            <div className="flex flex-col">
                                ...
                                <p className="font-sans text-gray-500 text-[11px]">Don't have an account? <a href="/auth/register" className="text-[11px] text-main">Register</a></p>
                            </div>
                            <form className="flex flex-col lg:w-80 xs:w-75 gap-3" onSubmit={handleSubmit(handleLogin)}>
                                <Controller name="identifier" control={control} render={({ field, fieldState }) => (
                                    <div className="flex flex-col gap-1">
                                        <Input {...field} aria-label="identifier" type="text" autoComplete="off" placeholder="Username or Email" className={`input rounded-md placeholder-gray-300 shadow-none ring-1 w-full max-w-xs text-xs font-sans ${fieldState.error ? "ring-main" : "ring-gray-200/75"}`} />
                                        {fieldState.error && (
